# OAuth Provider Setup Guide — Neyya.ai
...
3. Fill in:
   ...
   - Logo: upload Neyya logo
   - App domain: `https://neyya.ai`
   - Authorized domains: `neyya.ai`
...
6. Authorized redirect URIs:
   ```
   https://neyya.ai/api/auth/callback/google
   https://qa.neyya.ai/api/auth/callback/google
...
GOOGLE_REDIRECT_URI=https://neyya.ai/api/auth/callback/google
```
...
3. Fill in:
   ...
   - Redirect URI: **Web** → `https://neyya.ai/api/auth/callback/microsoft`
4. Click **Register**
...
2. Description: `Neyya Production`
...
2. Add redirect URIs:
   ```
   https://neyya.ai/api/auth/callback/microsoft
   https://qa.neyya.ai/api/auth/callback/microsoft
...
MICROSOFT_REDIRECT_URI=https://neyya.ai/api/auth/callback/microsoft
...
2. Description: `Neyya Web Login`
3. Identifier: `ai.neyya.web`
...
6. Configure:
   ...
   - Return URLs:
     ```
     https://neyya.ai/api/auth/callback/apple
     https://qa.neyya.ai/api/auth/callback/apple
     ```
7. Click **Save**
...
2. Valid OAuth Redirect URIs:
   ```
   https://neyya.ai/api/auth/callback/facebook
   https://qa.neyya.ai/api/auth/callback/facebook
   http://localhost:3001/api/auth/callback/facebook
   ```
3. Deauthorize Callback URL: `https://neyya.ai/api/auth/deauthorize/facebook`
...
3. Privacy Policy: `https://neyya.ai/privacy`
4. Terms: `https://neyya.ai/terms`
...
FACEBOOK_REDIRECT_URI=https://neyya.ai/api/auth/callback/facebook
```
...
| QA | `https://qa.neyya.ai` |
| Staging | `https://staging.neyya.ai` |
| Production | `https://neyya.ai` |
