 ...
 */
export function formatDateTime(dateTimeStr: string, locale = 'en-US'): string {
 ...
 */
export function formatTime(dateTimeStr: string, locale = 'en-US'): string {
  const date = new Date(dateTimeStr);
  if (isNaN(date.getTime())) {
    return dateTimeStr;
  }
 ...
 */
export function formatRelativeTime(dateTimeStr: string, now = new Date()): string {
