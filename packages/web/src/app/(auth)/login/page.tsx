      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-md bg-primary-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 disabled:opacity-50"
          >
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            ...
            <button
              ...
              onClick={() => {
                ...
                alert('Microsoft OAuth would redirect here. For local dev, use email/password.');
              }}
              className="flex items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24">
            ...
            <button
              type="button"
              onClick={() => {
                localStorage.setItem('loginProvider', 'apple');
                alert('Apple Sign In would redirect here. For local dev, use email/password.');
              }}
              className="flex items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
            >
            ...
            <button
              ...
              onClick={() => {
                ...
                alert('Facebook Login would redirect here. For local dev, use email/password.');
              }}
              className="flex items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
            >
